...
public class AddBook extends Fragment implements LoaderManager.LoaderCallbacks<Cursor> {
    ...
    private final String CODE_START = "978";
    private EditText mEanEditText;
    private TextView mNoBookFound;
    ...
    public View onCreateView(final LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        mNoBookFound = (TextView) rootView.findViewById(R.id.no_book_result);
    ...
    private void fetchBook(String ean) {
        ...
        if (ean.length() == 10 && !ean.startsWith(CODE_START)) {
            ean = CODE_START + ean;
        }
        if (ean.length() < 13) {
            clearFields();
    ...
    public android.support.v4.content.Loader<Cursor> onCreateLoader(int id, Bundle args) {
        ...
        if (eanStr.length() == 10 && !eanStr.startsWith(CODE_START)) {
            eanStr = CODE_START + eanStr;
        }
